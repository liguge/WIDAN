...
def parse_args():
    ...
    parser.add_argument('--data_dir', type=str, default='E:\博士数据集\PU', help='the directory of the data')
    ...
    parser.add_argument('--batch_size', type=int, default=240, help='batchsize of the training process')
